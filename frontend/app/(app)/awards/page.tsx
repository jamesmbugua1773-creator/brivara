...
export default function AwardsPage() {
  ...
  if (loading) return <div className="p-6">Loading awards…</div>;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium">Rank Rewards</h2>
        <div className="text-xs text-gray-400">Achieved ranks are highlighted; others are shown as locked.</div>
...
function AwardCard({ rank, reward, direct, teamPoints, achieved, prog }: { rank: string; reward: string; direct: string; teamPoints: string; achieved?: boolean; prog?: any }) {
      ...
      <div className="px-4 pb-4 pt-2">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 text-sm">
          <div className="flex items-start gap-2">
            ...
            <div>
              <div className="text-gray-400">Direct Requirement</div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <div className="text-gray-400">Team Points Requirement</div>
        ...
        {achieved ? (
          <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-turquoise/10 border border-turquoise px-3 py-1 text-xs text-turquoise">
            <span className="h-1.5 w-1.5 rounded-full bg-turquoise" /> Achieved
          </div>
        ) : (
